...
PALETTE_COVER_GRAY  = HexColor("#b0b0b0")  # cover meta/disclaimer text on black (readable)
...
COVER_META_GRAY = ParagraphStyle(
    ...
    alignment=TA_LEFT, textColor=PALETTE_COVER_GRAY, spaceBefore=1, spaceAfter=1,
)
