...
const AI300_METHODOLOGY = [
  ...
  { title: 'Sector Rotation Signal Architecture (Weekly Entry)', content: 'All 18 AI sectors are ranked daily by 5-day trailing return. Sectors ranked 1-6 are classified GO (strong momentum), 7-12 NEUTRAL, and 13-18 NO_GO (weak momentum). Entry signals are generated on Fridays using sector-optimized weekly EMAs (18-36 week periods). Buy Long (BL) signals fire when price closes above a rising EMA with a daylight zone confirmation. Sell Short (SS) signals fire on the inverse. Weekly entries execute at Monday open.' },
          ...
          {section === 'risk' && (
            <div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: 10, marginBottom: 24 }}>
                ...
                <MetricCard small label="Ulcer Index" value={fmt(net?.ulcerIndex)} sub="lower is better"
