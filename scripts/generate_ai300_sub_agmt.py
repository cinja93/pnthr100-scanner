...
OUT_PATH = os.path.join(OUT_DIR, "PNTHR_AI_Elite_300_SubAgmt_v1.0_2026.pdf")
...
def build_instructions():
    ...
    story.append(P("<b>PNTHR AI Elite 300 Fund, LP</b>", TITLE_STYLE))
    story.append(spacer(4))
    story.append(P("<b>Subscription Instructions</b>", SUBTITLE_STYLE))
    story.append(spacer(6))

    story.append(P(
        "A subscription to invest in PNTHR FUNDS, PNTHR AI Elite 300 Fund, LP "
    ...
    story.append(P(
        "<b>PNTHR FUNDS, PNTHR AI Elite 300 Fund, LP</b><br/>"
...
def build_signature_page():
    ...
    story.append(P(
        ...
        "limited partnership interests of PNTHR FUNDS, PNTHR AI Elite 300 Fund, "
        "LP.",
        BODY))
    ...
    story.append(P(
        ...
        "Interest of PNTHR FUNDS, PNTHR AI Elite 300 Fund, LP is accepted on the "
        "date specified below, subject to the provisions of the Subscription "
        "Agreement and the Limited Partnership Agreement.",
        BODY))

    story.append(spacer(8))
    story.append(P("<b>PNTHR FUNDS, PNTHR AI Elite 300 Fund, LP</b>", BODY_LEFT))
...
def build_subscription_agreement():
    ...
    story.append(P(
        ...
        "Partnership Agreement of <b>PNTHR FUNDS, PNTHR AI Elite 300 Fund, "
...
def build_appendix_d():
    ...
    story.append(P(
        ...
        "investment in PNTHR FUNDS, PNTHR AI Elite 300 Fund, LP (the "
...
def build():
    doc = make_doc_template(
        OUT_PATH,
        title_meta="PNTHR Funds, PNTHR AI Elite 300 Fund, LP - Subscription Agreement v1.0",
