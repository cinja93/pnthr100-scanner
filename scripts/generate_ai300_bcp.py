#!/usr/bin/env python3
"""
PNTHR AI Elite 300 Fund, LP — Business Continuity & Disaster Recovery Plan v1.0
...
Output: ~/Downloads/PNTHR_AI_Elite_300_BCP_v1.0_2026.pdf
"""
...
OUT_PATH = os.path.expanduser(
    f"~/Downloads/PNTHR_AI_Elite_300_BCP_{VERSION}_2026.pdf")
...
def build():
    ...
    story.append(Paragraph(
        ...
        "unwinding of all open positions using the PNTHR Proprietary Stop Loss System (PPSLS)",
        BULLET))
    story.append(Paragraph(
