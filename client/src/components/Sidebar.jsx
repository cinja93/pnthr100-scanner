  ...
  const internalGroup = effectiveAdmin
    ? {
        ...
        items: [
          ...
          { key: 'ir-live',           label: 'Intel Report (AI/Carn)', badge: 'AI | Carnivore', badgeType: 'split' },          { key: 'data-room',         label: 'Data Room (AI/Carn)', badge: 'AI | Carnivore', badgeType: 'split' },          { key: 'orders',            label: 'Orders', badge: 'AI | Carnivore', badgeType: 'split' },
