...
OUT_PATH = os.path.expanduser("~/Downloads/PNTHR_AI_Elite_300_GP_OpAgmt_v1.0_2026.pdf")
...
def build_cover():
    return build_cover_header(
        ...
        issuer_line="Company:  PNTHR Funds, LLC (General Partner of PNTHR AI Elite 300 Fund, LP)",
...
def build_legend():
    ...
    story.append(P(
        ...
        "PARTNER OF PNTHR FUNDS, PNTHR AI Elite 300 Fund, LP. THIS AGREEMENT MAY NOT "
...
def build_preamble():
    ...
    story.append(P(
        ...
        "PNTHR AI Elite 300 Fund, LP</b>, a Delaware limited partnership (the "
...
def build():
    doc = make_doc_template(
        OUT_PATH,
        title_meta="PNTHR Funds, LLC - Operating Agreement v1.0 (AI Elite 300)",
