...
// historical pullbacks (Oct 2023, Jul 2024). Weekly OpEMA = 26 (iterated:
// 21 → 20 → 23 → 24 → 26); the longer period sits higher and lets the bars
// touch the EMA on those pullbacks instead of cutting through. Daily kept at
// 21 pending observation. These can be re-tuned without affecting 679's
// sector-optimized EMA system — this index has its own EMA spec.
export const INDEX_EMA_DAILY_PERIOD  = 21;
export const INDEX_EMA_WEEKLY_PERIOD = 26;
