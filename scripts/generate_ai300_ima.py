...
Output: ~/Downloads/PNTHR_AI_Elite_300_IMA_v1.0_2026.pdf
"""
...
OUT_PATH = os.path.expanduser("~/Downloads/PNTHR_AI_Elite_300_IMA_v1.0_2026.pdf")
...
def build_legend():
    ...
    story.append(P(
        ...
        "RELATING TO PNTHR FUNDS, PNTHR AI Elite 300 Fund, LP (the &ldquo;FUND&rdquo;) "
...
def build_preamble():
    ...
    story.append(P(
        ...
        "or &ldquo;Manager&rdquo;), and <b>PNTHR FUNDS, PNTHR AI Elite 300 Fund, LP</b>, "
...
def build_signatures():
    ...
    story.append(P("PNTHR FUNDS, PNTHR AI Elite 300 Fund, LP", BODY))
...
def build():
    doc = make_doc_template(
        OUT_PATH,
        title_meta="PNTHR Funds, PNTHR AI Elite 300 Fund, LP - Investment Management Agreement v1.0",
