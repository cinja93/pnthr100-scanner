...
async function main() {
  ...
  console.log('  PNTHR AMBUSH V7 — GRADUATED SIZING BACKTEST');
  console.log('  1H Stop (firstHourLow - fees) — FULL vs GRADUATED (50%→75%→100%)');
  ...
  // ── HEAD-TO-HEAD TABLE ────────────────────────────────────────────────────
  console.log('\n' + '='.repeat(180));
  console.log('  V7A 1H-STOP — FULL SIZE vs GRADUATED (50%→75%→100%)');
