...
// historical pullbacks (Oct 2023, Jul 2024). Weekly OpEMA = 24 (iterated:
// 21 → 20 → 23 → 24); the longer period sits higher and lets the bars touch
...
export const INDEX_EMA_WEEKLY_PERIOD = 24;
