#!/usr/bin/env python3
"""
PNTHR AI Elite 300 Fund, LP — Key Personnel v1.0
...
Changes from Carnivore v1.3:
  ...
  - Cindy's Fund Operations row updated for AI Elite 300

Output: ~/Downloads/PNTHR_AI_Elite_300_Key_Personnel_v1.0_2026.pdf
"""
...
OUT_PATH = os.path.expanduser(f"~/Downloads/PNTHR_AI_Elite_300_Key_Personnel_{VERSION}_2026.pdf")
...
def build():
    ...
    story.append(P(
        ...
        "ground up, including the signal detection algorithm, multi-dimensional "
        "Kill scoring framework, pyramid entry system, PNTHR Proprietary Stop "
        "Loss System (PPSLS), and all risk management protocols. This technology "
    ...
    story.append(detail_table([
        ...
        ("Notable Achievement",
         "Designed a system that backtested to a 2.59 Gross Sharpe ratio "
         "(daily resolution, excess over US 3-month Treasury) and 11.22x profit "
         "factor across 2,614 closed pyramid trades (2,623 initiated) over 7+ "
         "years, encompassing both bull markets and major drawdowns (COVID crash, "
         "2022 bear market, 2025 Liberation Day correction)"),
    ]))
